            ...
            close()
                .then(r =>
                {
                    ...
                    try
                    {
                        ...
                        // Allow path-style addressing for S3-compatible services
                        if (args.args && (Object.prototype.hasOwnProperty.call(args.args, 'force-path-style')
                                         || Object.prototype.hasOwnProperty.call(args.args, 'forcePathStyle')))
                        {
                            let fps = args.args['force-path-style'];
                            if (undefined === fps)
                                fps = args.args.forcePathStyle;
                            fps = String(fps).toLowerCase();
                            clientConfig.forcePathStyle = !['0', 'false', 'no', 'off'].includes(fps);
                        }
