...
/** gdriveClient()
    ...
    Provides google drive functionality
...
{
    const {google} = require('../setup.js').requireBackend('googleapis', 'gdrive://');
    ...
    */
    function getAccessToken()
    {
        return new Promise((resolve, reject) =>
        {
            ...
            let oAuth2Client = new google.auth.OAuth2(client_id, client_secret, `http://localhost:${opts.authport}`);
            ...
            return auth.getAuthCode(opts.authport)
                .then(r =>
                {
                    ...
                    oAuth2Client.getToken(r.code, (err, token) =>
                    {
                        if (err)
            ...
            gDrive.files.list(q, (err, res) =>
                {
                    ...
                    {   if (opts.verbose)
                            Log(res);
                        return reject(`Invalid response finding : ${id}`);
                    }
    ...
    */
    function getItemInfo(item, o={recursive:true}, parentId=null, find=null)
    {
        if (null === find)
        ...
        return new Promise((resolve, reject) =>
        {
            ...
            gDrive.files.list(req, (err, res) =>
            {
                ...
                {   let r = res.data.files[0];
                    if (!find.length)
                        return resolve(r);
                    return resolve(getItemInfo(item, o, r.id, find));
                }
                ...
                gDrive.files.create(
                    ...
                    {   if (!find.length)
                        ...
                        return resolve(getItemInfo(item, o, r.data.id, find));
                    });
            });
    ...
    */
    ...
    {   return getItemInfo(dir, {...o, create:true});
    }
    ...
    */
    ...
    {   return getItemInfo(file)
            ...
            .catch(e =>
            {   // Item not found is OK for delete operations
                if (String(e).startsWith('Not found:')) return null;
                throw e;
            });
    }
