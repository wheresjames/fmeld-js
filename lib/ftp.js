    ...
    */
    function mkDir(dir, opts={})
    {
        ...
        return new Promise((resolve, reject) =>
        {
            ...
            client.mkdir(dir, opts.recursive ? true : false, (err) =>
            {   if (err)
                    return reject(err);
                return resolve(true);
            });
    ...
    function createWriteStream(file)
    {
        ...
        return new Promise((resolve, reject) =>
        {
            ...
            try
            {
                ...
                client.put(file, tx, function (err)
                {   if (err)
                        reject(err);
                    resolve(tx);
                });
                ...
                // client.put(file, rs, function (err)
                // {   Log(`put() ${file}`);
                //     if (err)
                //         reject(err);
                //     resolve(ws);
                ...
                //     if (!connected)
                //     {   connected = true;
                //         client.put(file, ws, function (err)
                //         {   Log(`put() ${file}`);
                //             if (err)
                //                 reject(err);
                //         });
